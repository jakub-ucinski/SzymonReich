    ...
    <div class="container">
      ...
      <div class="header-content animated fadeIn delay-05">
        ...
        <ul class="list-unstyled list-social">
          ...
          <li id='icomoon-li'><a href="https://www.youtube.com/channel/UCFqPlDL6ESG5lP1AwtjzxDg"><i class="icon-dzn icomoon-icon"></i></a></li>
          <li><a href="//open.spotify.com/artist/1MzFJR6MaPjYS4A5J62DA6?si=r74R6WoSR9-PJXiCcrv06Q"><i class="fab fa-spotify"></i></a></li>
        </ul>
      ...
      <div class='container wow fadeInLeft'>
          ...
          <div class='section-content'>
              <div class="general-about">
                  ...
                  <p>
                      Gdy byłem młodszy, chciałem, aby znalazł się ktoś, kto porozmawia ze mną na trudne tematy. Dziś staram się być taką osobą dla innych. 
                      <br>
                      <br>
                      Zauważam, jak wielu młodych boryka się z tematami, które sam musiałem przerobić - poczucie braku sensu i osamotnienia, lęki społeczne, bariery w komunikacji intra- oraz interpersonalnej. Po rówieśnikach rozpoznaję, że niekoniecznie są to problemy, z których się po prostu “wyrasta”. Odwiedzając szkoły i przez social media dzielę się tym, jak niektóre wartości - miłość, odpowiedzialność, empatia, inicjatywność, odwaga - pomagają mi nawigować przez życie, dzieląc się przy tym wiarą chrześcijańską.
                  </p>
              </div>
  
              <div class="help-invite">Mogę Ci pomóc jako:</div>
              <div class='section_switcher'>
                  <h3><span id='Model_pick' class='focused_on hvr-float'>Model</span> <span class='hvr-float' id='Muzyk_pick'>Muzyk</span> <span class='hvr-float' id='Ministrant_pick'>Ministrant</span></h3>
              </div>
              ...
              <div id='about_texts'>
                  ...
                  <div class='about_text focused_on' id='model_text'>
                      ...
                      Rozpoznawalność zyskałem dzięki udziałowi w programach telewizyjnych Topmodel Polska oraz Hotel Paradise. Modelingiem zajmuję się od dziecka i zrealizowałem kampanie dla marek jak Tchibo, Esprit, OTTO, Normani. Dziś jestem reprezentantem Fitness Catering. Modeling pełni ważną rolę w moim życiu jako praca, staram się jednak stopniowo poświęcać swojej pasji, czyli muzyce i inspiracji innych. 
                      </span>
                      ...
                      <div class='align-buttom'>
                          <div class='highlighted_achivements'>
                              ...
                              <div class='achievement'>
                                  <div class='achievement_big'><img src="img/wspolpraca_loga_nomargin/Fitness_catering_logo.png" alt=""></div>
                                  <div class='achievement_small'>Ambasador marki Fitness Catering</div>
                              </div>
                          </div>
  
                          <a href='#contact-section' class='contact-button btn btn-dark js-scroll-trigger hvr-radial-out'>Współpraca<i class="fas fa-chevron-down"></i></a>
                      </div>
                  ...
                  <div class='about_text' id='muzyk_tekst'>
                      ...
                      W życiu staram się cieszyć wszystkim, ale jest coś, czego nie trawię - monotonia. Kocham zmiany, ruch, lubię, gdy się coś dzieje. Jako nastolatek jednakże mało angażowałem się w kreatywne projekty. Wychowano mnie tak, aby osiągać najlepsze wyniki w szkole, co też przyniosło swoje owoce. Mój wewnętrzny buntownik nie mógł jednak usiedzieć w spokoju zbyt długo. Angażując się w różne projekty, pomagałem znajomym w realizacji swoich wizji. Pierwszy teledysk, w którym brałem swój udział, miał ponad 10 milionów wyświetleń! Poruszony wyjątkową sytuacją życiową w zeszłym roku nagrałem pierwszy teledysk. “Jestem BLESSED” uzyskało 300 tys. wyświetleń. “Jesteś BLESSED, jesteś BLESSED - wrzuć na luz, po co Ci stres; znajdź swój cel, ja swój znam, a Ty jaki masz?” - ciekawe, że muzyka jest narzędziem, które pozwala mi dzielić się swoim wnętrzem z innymi, a z drugiej strony - podczas tworzeniu jej sam stale się czegoś uczę. 
                      </span>
                      ...
                      <div class='align-buttom'>
                          ...
                          <a href='#contact-section' class='contact-button btn btn-dark js-scroll-trigger hvr-radial-out'>Collab<i class="fas fa-chevron-down"></i></a>
                  ...
                  <div class='about_text' id='ministrant_tekst'>
                      ...
                      Jestem ministrantem (ministrare - służyć). Jednak moja służba i pomoc innym wychodzi poza ramy kościoła. W zeszłym roku odwiedziłem ok. 11.000 młodych w szkołach czy masowych wydarzeniach. Angażuję się w projekty społeczne i jestem uczestnikiem Ligi NGO’s dla aktywistów i przyszłych liderów. Szukam sposobów, aby dzielić się wiarą, z którą łączę optymizm, wiarę w ludzkie dobro, nadzieję na lepsze jutro i że warto próbować: realizować siebie, być stale lepszym człowiekiem, dawać i dążyć do ogólnego dobra. Dlatego też, wiara pełni centralną rolę w moim życiu i jest motorem wszelkich działań. Dotknięty przykrościami życia wielu przyjaciół, ale też własnych doświadczeń, szerzę poglądy, które uważam, że mogą wielu osobom pomóc. Na wystąpieniach publicznych omawiam tematy typu: sukces - więcej niż tylko pieniądze?, optymizm i samorealizacja, kluczowe wartości: rodzina, odpowiedzialność, miłość oraz odpowiadam na pytanie  “Jak to jest być osobą wierzącą w show-biznesie?”.                </span>
                      ...
                      <div class='align-buttom'>
                          <div class='highlighted_achivements'>
                              ...
                              <div class='achievement'>
                                  <div class='achievement_big' style='margin-top: 7px;'><img id='do-zoba-img' src="img/wspolpraca_loga_nomargin/Do_zobaczenia_w_niebie.png" alt=""></div>
                                  <div class='achievement_small'>Prezenter kanału "Do zobaczenia w Niebie"</div>
                              </div>
                          </div>
                          
                          <a href='#contact-section' class='contact-button btn btn-dark js-scroll-trigger hvr-radial-out'>Zaproś mnie jako mówcę lub artystę<i class="fas fa-chevron-down"></i></a>
                      </div>
          ...
          <div class='achievement-slider'>
              <div id='partnerships' class='achievement_content'>
                  ...
                  <div class='owl-carousel owl-6 section_items'>
                      ...
                      <a href='//fitnesscatering.com.pl/TAK-SMAKUJE-PASJA-cinfo-pol-96.html'><img class='item' src="img/wspolpraca_loga_nomargin/Fitness_catering_logo.png" alt=""></a>
              ...
              <div id='projects' class='achievement_content'>
                  ...
                  <div class='owl-carousel owl-2 section_items'>
                      ...
                      <a href='//www.ligangos.pl'><img class='item' src="img/wspolpraca_loga_nomargin/ligangos.png" alt=""></a>
                      <a href='//www.youtube.com/channel/UCFqPlDL6ESG5lP1AwtjzxDg'><img class='item' src="img/wspolpraca_loga_nomargin/Do_zobaczenia_w_niebie.png" alt=""></a>
                  </div>
              </div>
              ...
              <div id='more' class='achievement_content'>
                  ...
                  <div class='owl-carousel owl-2 section_items'>
                      ...
                      <a href='//deon.pl/wiara/swiadectwa/szymon-reich-z-top-model-zachwyca-nowa-piosenka-i-szczerym-swiadectwem-dot-wiary-w-boga-wideo,682155?fbclid=IwAR2erkXham6cI8njKOX5dQqznesSOeD25-o2f14QD5QSEZpg5ystjp5OxPY'><img id='deon-logo' class='item' src="img/wspolpraca_loga_nomargin/deon.png" alt=""></a>
                      <a href='//dziendobry.tvn.pl/a/szymon-reich-bozy-wariat-ktory-czuje-powolanie-by-glosic-wiare-w-boga'><img class='item' src="img/wspolpraca_loga_nomargin/ddt_logo.png" alt=""></a>
                  </div>
              </div>
          </div>
      </div>
